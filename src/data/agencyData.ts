...
import himaniPortrait from '../assets/images/himani_manager_portrait_1786951098087.jpg';
...
export const COURSES_DATA: Course[] = [
  {
    ...
    price: 49,
    pricePKR: 'Rs. 4,999',
    originalPricePKR: 'Rs. 10,000',
    level: 'Beginner to Advanced',
    description: 'Complete 1-month hands-on digital marketing training covering social media strategies, lead generation, funnel building, and client acquisition.',
    syllabus: [
      'Digital Marketing Fundamentals & Funnels',
      'Social Media Strategy & Content Planning',
      'Lead Generation & Email Marketing',
      'Client Acquisition & Proposal Writing',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Instructor Support'
    ]
  },
  {
    ...
    price: 49,
    pricePKR: 'Rs. 4,999',
    originalPricePKR: 'Rs. 9,000',
    level: 'Beginner to Advanced',
    description: 'Master organic growth, community management, grid design, and engagement strategies across Instagram, Facebook, and LinkedIn.',
    syllabus: [
      'Platform Algorithms & Audience Building',
      'Instagram Grid Aesthetic & Viral Reels Strategy',
      'LinkedIn B2B Authority & Organic Growth',
      'Community Management & Content Calendars',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
  ...
  {
    id: 'meta-ads',
    name: 'Meta Ads Mastery (Facebook & Instagram)',
    category: 'Marketing',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    price: 59,
    pricePKR: 'Rs. 5,999',
    originalPricePKR: 'Rs. 12,000',
    level: 'Beginner to Advanced',
    description: 'Step-by-step Meta Ads training to launch high-ROAS campaign funnels, setup Meta Pixel, CAPI, lookalike audiences, and ad scaling.',
    syllabus: [
      'Business Manager, Pixel & CAPI Setup',
      'Audience Research & Lookalike Targeting',
      'High-Converting Ad Copy & Creative Design',
      'A/B Testing, Scaling & ROAS Optimization',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Instructor Support & Live Case Studies'
    ]
  },
  {
    id: 'google-ads',
    ...
    price: 59,
    pricePKR: 'Rs. 5,999',
    originalPricePKR: 'Rs. 11,000',
    level: 'Beginner to Advanced',
    description: 'Learn Google Search Ads, Performance Max, Display, and YouTube advertising to capture high-intent buyers for client businesses.',
    syllabus: [
      ...
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Client Projects'
    ]
  },
  {
    id: 'seo',
    name: 'SEO & Search Engine Ranking',
    category: 'Marketing',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    originalPricePKR: 'Rs. 10,000',
    level: 'Beginner to Advanced',
    description: 'Comprehensive SEO course covering Technical Audits, On-Page Optimization, Keyword Research, and High-DA Backlink Building.',
    syllabus: [
      'Keyword Research & Search Intent Mapping',
      'On-Page SEO & Content Optimization',
      'Technical SEO Audits & Schema Markup',
      'Link Building & Local SEO Strategy',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
  ...
  },
  {
    ...
    name: 'Graphic Designing & Photoshop',
    category: 'Design',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    originalPricePKR: 'Rs. 9,000',
    level: 'Beginner to Advanced',
    description: 'Learn professional visual design principles, Adobe Photoshop, Illustrator, layout design, branding assets, and ad banner creation.',
    syllabus: [
      ...
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Instructor Support & Portfolio Projects'
    ]
  },
  {
    ...
    price: 39,
    pricePKR: 'Rs. 3,999',
    originalPricePKR: 'Rs. 7,500',
    level: 'Beginner to Advanced',
    description: 'Fast-track design course using Canva Pro to create stunning social media carousels, logos, brand kits, reels, and presentations.',
    syllabus: [
      'Canva Pro Tools & Brand Kit Setup',
      'High-Converting Social Media Carousels',
      'Short Video Editing & Reel Templates',
      'E-Book & Client Proposal Design',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Template Packs'
    ]
  },
  {
    id: 'web-development',
    ...
    originalPricePKR: 'Rs. 12,000',
    level: 'Beginner to Advanced',
    description: 'Practical frontend web development training to code responsive websites, interactive UI components, and modern portfolio projects.',
    syllabus: [
      'HTML5, CSS3 & Modern Flexbox/Grid',
      'JavaScript ES6+ Essentials & DOM Manipulation',
      'React Fundamentals & Component Architecture',
      'Tailwind CSS Styling & Responsive Web Design',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Instructor Support & Real Projects'
    ]
  },
  {
    id: 'wordpress',
    ...
    originalPricePKR: 'Rs. 10,000',
    level: 'Beginner to Advanced',
    description: 'Build professional business websites and full-fledged WooCommerce online stores without writing code.',
    syllabus: [
      ...
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Client Case Studies'
    ]
  },
  {
    ...
    price: 39,
    pricePKR: 'Rs. 3,999',
    originalPricePKR: 'Rs. 8,000',
    level: 'Beginner to Advanced',
    description: 'Learn how to create high-ranking Fiverr gigs, optimize keywords, communicate with foreign buyers, and achieve Level 1 & 2 seller status.',
    syllabus: [
      'Fiverr Niche Selection & Keyword Research',
      'High-Converting Gig Title, Description & Images',
      'Buyer Communication & Order Management',
      '5-Star Rating Strategies & Level Up Roadmap',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Instructor Support & Gig Review Sessions'
    ]
  },
  {
    id: 'upwork-freelancing',
    name: 'Upwork Freelancing & Client Acquisition',
    category: 'Freelancing',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    price: 49,
    pricePKR: 'Rs. 4,999',
    originalPricePKR: 'Rs. 9,500',
    level: 'Beginner to Advanced',
    description: 'Master Upwork profile optimization, winning proposal writing, hourly & fixed-price contract management, and long-term retainer clients.',
    syllabus: [
      '100% Complete Professional Profile Setup',
      'Winning Cover Letter & Proposal Frameworks',
      'Interview Handling & Client Contract Management',
      'Direct Client Pitching Outside Upwork',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Real Projects'
    ]
  ...
  {
    id: 'amazon-va',
    name: 'Amazon Virtual Assistant (VA)',
    category: 'E-Commerce',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    originalPricePKR: 'Rs. 12,000',
    level: 'Beginner to Advanced',
    description: 'Learn Amazon FBA & FBM account management, product research (Helium 10 & Jungle Scout), listing optimization, and PPC ad campaigns.',
    syllabus: [
      'Amazon Business Models (FBA & FBM)',
      'Product Hunting with Helium 10 & Jungle Scout',
      'Keyword Research & Listing Optimization',
      'PPC Advertising & Account Management',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Instructor Support & Hands-on Tools'
    ]
  },
  {
    id: 'ebay',
    name: 'eBay Empowerment & E-Commerce',
    category: 'E-Commerce',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    originalPricePKR: 'Rs. 10,000',
    level: 'Beginner to Advanced',
    description: 'Master product sourcing, store setup, SEO titles, listing creation, and international customer fulfillment on eBay.',
    syllabus: [
      'eBay Store Creation & Account Health',
      'Product Sourcing & Profit Margin Calculation',
      'Optimized Item Titles & Description HTML',
  ...
  },
  {
    ...
    originalPricePKR: 'Rs. 8,000',
    level: 'Beginner to Advanced',
    description: 'Learn how to write SEO blog articles, persuasive sales page copy, email newsletter sequences, and engaging social media posts.',
    syllabus: [
      'Persuasive Copywriting Formulas (AIDA, PAS)',
      'SEO Blog Article Research & Structuring',
      'Ad Copy & Social Captions That Sell',
      'Portfolio Creation & Freelance Writing',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Instructor Review'
    ]
  },
  {
    id: 'video-editing',
    ...
    originalPricePKR: 'Rs. 10,000',
    level: 'Beginner to Advanced',
    description: 'Master Adobe Premiere Pro, CapCut Pro, and After Effects to edit viral short-form Reels, YouTube videos, and commercial ad edits.',
    syllabus: [
      'Timeline Cutting, Transitions & Speed Ramps',
      'Dynamic Subtitles & Caption Animations',
      'Sound Design, Color Grading & FX',
      'Client Video Ad Creation Workflow',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Real Projects'
    ]
  },
  {
    ...
    name: 'YouTube Automation & Growth',
    category: 'Content',
    duration: '1 Month',
    certificate: true,
    instructor: 'Abeera Nadeem Bajwa',
    ...
    originalPricePKR: 'Rs. 9,000',
    level: 'Beginner to Advanced',
    description: 'Learn how to create high-yielding YouTube faceless channels, scriptwriting, voiceovers, video production, and monetization.',
    syllabus: [
      'Niche Selection & Channel Setup',
      'AI Scriptwriting & Voiceover Tools',
      'Faceless Video Assembly & Thumbnail Design',
      'SEO Tags, YouTube Monetization & Growth',
      'Professional Certificate Included',
      'Lifetime Access to Course Recordings',
      'Practical Assignments & Case Studies'
    ]
